...
class EmbeddingService:
    ...
    def generate_embeddings(self, texts, video_title):
        ...
        for i, text in enumerate(texts):
            ...
            input_ids = self.bert_tokenizer.encode(text.page_content, return_tensors='pt')
            ...
            metadata = {"chunk_number": i, "text_length": len(text.page_content), "video_title": video_title}
    ...
    def embed_transcript(self, text_file: str, chrome_client, namespace_id, video_title):
        """
        ...
        # Generate embeddings
        vector_embeddings, vector_documents, vector_metadatas, vector_ids = self.generate_embeddings(docs,video_title)
