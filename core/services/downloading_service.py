...
class DownloadingService:
    ...
    def _download_from_youtube(self):
        ...
        # Add a random user agent to the Chrome options
        ...
        try:
            ...
            with YoutubeDL(ydl_opts) as ydl:
                ...
                video_duration_formatted = str(
                    timedelta(seconds=video_duration_seconds)
                )
        ...
        # Return the file path, title, and duration
        return {
